...
import torch
import random
from load import PROCESSED_DIR, MODEL_DIR, make_loader
from train_ssl import train_autoencoder, evaluate_reconstruction
...
print("\nTraining AE...")
ae_model = train_autoencoder(train_loader_ssl, epochs=10, masked=False)
torch.save(ae_model.state_dict(), MODEL_DIR / 'ae_full.pth')
torch.save(ae_model.encoder.state_dict(), MODEL_DIR / 'encoder_ae.pth')

print("\nTraining MAE...")
mae_model = train_autoencoder(train_loader_ssl, epochs=10, masked=True, mask_ratio=0.3)
